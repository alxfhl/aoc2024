...
public class Day14 {
    ...
    public static long getPart1(List<String> lines, long width, long height, long steps) {
        ...
        for (String line : lines) {
            ...
            Coord pos = new Coord(longs.get(0), longs.get(1));
            Coord v = new Coord(longs.get(2), longs.get(3));
    ...
    private static long count(List<Coord> positions, long minX, long minY, long maxX, long maxY) {
    ...
    public static long getPart2(List<String> lines, long width, long height) {
        for (int steps = 0; steps < 100000; steps++) {
            ...
            for (String line : lines) {
                ...
                positions.add(new Coord(endX, endY));
